<template>
  <div>
    <!-- 面包屑导航区域 -->
    <nav-header title1="商品管理" title2="参数列表"></nav-header>
...
export default {
  ...
  methods: {
    ...
    showInput (rowInfo) {
      ...
      // 让文本里自动获得焦点
      // $nextTick 方法的作用：当页面上元素被重新渲染之后，才会指定调用回调函数中代码
      this.$nextTick((_) => {
        this.$refs.saveTagInput.$refs.input.focus()
      })
    },
    // 删除对应的参数可选项
    handleClose (i, rowInfo) {
